...
<head>
    ...
    <?php require_once 'panelsfr/head.html'?>
    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse navbar-right navbar-main-collapse">
        <ul class="nav navbar-nav">
          ...
          <li>
            <a href="index.php?fr#accommodation"><i class="fa fa-angle-double-left"></i> Back</a>
          </li>
        </ul>
      </div>
    </div>
    ...
    <div class="intro-section">
      <div class="container">
        <div class="col-lg-8 col-lg-offset-2 text-center">
          ...
          <p>
            ...
            <span class="network-name">Voir le plan</span></a>
          </p>
          <p>
      ...
      <div class="container">
        <div class="col-md-offset-2 col-md-8 text-center">
          <p>
            Nous avons également sélectionné quelques autres hôtels à proximité du Centre des Congrès
            pour élargir votre choix. Il n'y a pas de tarif spécial pour ces hôtels.
          </p>
        </div>
      </div>
